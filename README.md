...
[![npm](https://img.shields.io/npm/v/rn-viewpager-lb.svg?style=plastic)](https://npmjs.org/package/rn-viewpager-lb) [![npm](https://img.shields.io/npm/dm/rn-viewpager-lb.svg?style=plastic)](https://npmjs.org/package/rn-viewpager-lb) [![npm](https://img.shields.io/npm/dt/rn-viewpager-lb.svg?style=plastic)](https://npmjs.org/package/rn-viewpager-lb)
...
### Install from npm:
`npm install --save rn-viewpager-lb`
...
import {PagerTabIndicator, IndicatorViewPager, PagerTitleIndicator, PagerDotIndicator} from 'rn-viewpager-lb';
